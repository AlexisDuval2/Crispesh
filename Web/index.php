			...
			<section class="full-section parallax" id="section-15" data-stellar-background-ratio="0.1">
                ...
                <div class="container">
                    ...
                    <!--<div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="headline" id="titre_partenaire">
				...
				<!--div class="row">
					<div class="col-sm-12">
						...
						<div class="owl-carousel logos col_img_3">
                            <div>
                                <img src="images/logos/meesr.jpg" alt="">
                            </div>
                            <div class="border_right_verte">
                                <img src="images/logos/meie.jpg" alt="">
                            </div>
                            <div>
                                <img src="images/logos/dawson.jpg" alt="">
                            </div>

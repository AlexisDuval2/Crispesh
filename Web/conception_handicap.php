...
<?php
	require_once("action/ConceptionHandicapAction.php");
	$action = new ConceptionHandicapAction();
	$action->execute();
					...
					<div class="row">
						...
						<div class="col-sm-7">
							<div class="blog-article">
								...
								<p>
									<span style="color: #059ce1;">
										<strong>
											<em>Le handicap fait partie de la condition humaine - pratiquement tout le monde, à un moment ou l'autre de la vie, aura une déficience temporaire ou permanente et ceux qui parviendront à un âge avancé connaîtront des difficultés fonctionnelles croissantes.</em>
										</strong>
									</span>
								</p>
								<p>
									<span style="color: #059ce1;">
										<strong>
											<em>Organisation Mondiale de la Santé, 2011, 7</em>
										</strong>
									</span>
								</p>

									...
									<div class="row">
										...
										<div class="col-sm-8">
											<div class="portfolio-item-details">
												<h4>
													<a href="projet_photographie_expression.php" rel="bookmark" title="La photographie comme moyen d’expression, de participation sociale, d’autodétermination et d’inclusion  des étudiants en situation de handicap au collégial (2015-2016)">
												...
												<a class="btn btn-blue" href="projet_photographie_expression.php">Voir les détails du projet</a>
								...
								<div class="portfolio-item">
									<div class="row">
										...
										<div class="col-sm-8">
											<div class="portfolio-item-details">
												<h4>
													<a href="projet_ameliorer_sommeil.php" rel="bookmark" title="Améliorer les conditions de sommeil de l’enfant vivant avec un trouble du spectre de l’autisme  grâce à un design réfléchi et personnalisé de sa chambre (2016-2017)">
												...
												<a class="btn btn-blue" href="projet_ameliorer_sommeil.php">Voir les détails du projet</a>
											</div><!-- portfolio-item-details -->
										</div><!-- col -->
									</div><!-- row -->
								</div><!-- portfolio-item -->

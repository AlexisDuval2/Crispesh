...
<?php
	require_once("action/ProjetAmeliorationFrancaisAction.php");
	$action = new ProjetAmeliorationFrancaisAction();
	$action->execute();
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-sm-8 texte-projet">
							...
							?>
							<div id="index-texte">
								<?php echo ContentDao::lire_texteProjet(); ?>
							</div>
							<?php } ?>
							...
							<div class="col-sm-12">
								...
								<h6>Chercheuse</h6>
								<p>Evelyne Pitre</p>
								<p>Enseignante au Cégep du Vieux Montréal</p>
							...
							<div class="col-sm-12">
								...
								<h6>Chercheur</h6>
								<p>Marc Tremblay</p>
								<p>Fondateur et Coordonnateur, Solutions aides technologiques</p>
							</div>
							<div class="col-sm-12">
								<hr>
								<h6>Assistants de recherche</h6>
								<p>Alexandra Cloutier</p>
								<p>Mathieu Lauzon-Dicso</p>
								<p>Camille Raunet</p>
							</div>
							<div class="col-sm-12">
							<hr>

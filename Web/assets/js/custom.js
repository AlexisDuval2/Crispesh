...
(function($){
	...
	$(document).ready(function(){
        ...
        // MENU NOS SERVICES //
        $("#menu_service a, #list_sections_a_propos a").click(function(){
            var aTag = $("#"+$(this).attr('name')).offset().top;
            $('html,body').animate({scrollTop: aTag - ($("#header").height() + 25)},'slow');
        });

        $('#liste_liens_outils > li > strong').click(function(){
           $(this).closest('li').toggleClass('ouvert').find('ul').slideToggle(500);
        });

        $("#btn_accessibilite").click(function(){
            $('#header-accessibilite').slideToggle(500);
        });

        $("#btn_contraste_eleve").click(function(){
           $('body').toggleClass('contraste_eleve');
        });

        $("#btn_niveau_gris").click(function(){
            $('body').toggleClass('niveau_gris');
        });

        $("#btn_taille_police").click(function(){
            $('body').toggleClass('taille_police');
        });
        ...
        $(".owl-carousel.logos.col_img_2").owlCarousel({
            items: 2,
            itemsDesktop: [1199,4],
            itemsDesktopSmall: [991,3],
            itemsTablet: [767,2],

                    ...
                    <div class="row">
						...
						<div class="col-sm-9">
							...
							<ol class="breadcrumb">
                                ...
                                <li><a href="services_conseils.php">Nos services</a></li>							
                                <li class="active">Laboratoire en technologies adaptatives</li>
                            </ol>
					...
					<div class="col-sm-5">												
						<div class="widget widget-categories">																				
							<ul>
								...
								<li class="active"><a href="laboratoire_technologies_adaptatives.php">Laboratoire en technologies adaptatives</a></li>

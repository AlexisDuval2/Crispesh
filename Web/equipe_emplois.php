...
<?php
	require_once("action/EquipeEmploisAction.php");
	$action = new EquipeEmploisAction();
	$action->execute();
			...
			<div id="content">
						...
						<div class="row">
							...
							<div class="col-sm-8">
								<ol class="breadcrumb">
									...
									<li class="active">Emplois au CRISPESH</li>
								</ol>
							</div><!-- col -->
						</div><!-- row -->
					</div><!-- container -->
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-sm-7">
							<div class="col-sm-12">
								<h1>Emplois au CRISPESH et
									<p>formation de la relève scientifique</p>
								</h1>

    ...
    <div id="content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
				<br>
                    <center><h1>Conception d’un vêtement de compression adapté pour des adolescents et de jeunes adultes vivant avec un trouble du spectre de l’autisme (2015-2016)</h1></center>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4">
                    <img src="images/projets/vestes.jpg" alt="Conception d’un vêtement de compression adapté pour des adolescents et de jeunes adultes vivant avec un trouble du spectre de l’autisme 2015-2016">
				</div>

					...
					<div class="row">
						...
						<div class="col-sm-8">
							...
							<div class="col-sm-12">
								<hr>
								<h6>Chercheur</h6>
								<p>Jean-Sébastien Goulet</p>
							</div>
							<div class="col-sm-12">
								<hr>
								<h6>Assistante de recherche</h6>
								<p>Aurélie Angrignon Atkins</p>
								<p>Étudiante en Techniques de gestion de commerces au Cégep du Vieux Montréal</p>
							</div>
							<div class="col-sm-12">
								<hr>
								<h6>Partenaire</h6>
								<p>Centre intégré de santé et de services sociaux de la Montérégie-Ouest (CISSSMO)</p>
							</div>
							<div class="col-sm-12">
								<hr>
